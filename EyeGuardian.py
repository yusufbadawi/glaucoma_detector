...
st.sidebar.info(
    ...
    **Supervised By: Dr Mahmoud Khalil**
    ...
    By simply uploading a fundus eye image, users can receive an assessment that helps in identifying the presence of glaucoma, potentially saving vision through early intervention.
    """
)
st.sidebar.write("---")
